  ...
  return (
    <div className="max-w-3xl mx-auto">
      <header className="flex items-center gap-10 mt-10">
        ...
        <h1 className="text-2xl font-bold text-center">The free, fun, and effective method to learn Italian!</h1>
        ...
        <Link className="bg-green-400 px-16 rounded-full py-2 font-semibold" href="/dashboard">Start now for free</Link>
        </div>
        <div>
      ...
      <section className="grid">
        ...
        <article className="flex gap-8">
          <div>
            <img src="https://via.placeholder.com/200" alt="impari al tuo ritmo" />
          </div>
          <div>
            <h3 className="font-semibold text-lg">Impara in compagnia, impara di più</h3>
            <p>Lasciati alle spalle i libri di testo! Esercitati con la pronuncia, avvicinati a nuove culture e scambia suggerimenti linguistici con la nostra community globale di studenti.</p>
          </div>
        </article>
        <article className="flex gap-8">
          <div>
